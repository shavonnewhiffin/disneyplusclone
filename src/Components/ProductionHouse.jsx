...
const ProductionHouse = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-center gap-2 md:gap-5 p-2 px-5 md:px-16 sm:w-[550px] md:w-auto sm:m-auto">
        ...
        <div className="group relative border-[2px] border-gray-600 rounded-lg hover:scale-110 transitional-all duration-300 ease-in-out cursor-pointer shadow-xl  shadow-gray-800">
